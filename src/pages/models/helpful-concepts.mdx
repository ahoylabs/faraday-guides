...
More recently, several other base models have been released that use the same architecture as llama and are compatible with Faraday. *Mistral* is a 7B model that has largely replaced LLama 2 7B in use, and a group of researches released *Yi* in multiple sizes that looks promising.
