...
Faraday is a chat application that enables rich, meaningful interactions with personalized AI. Faraday simplifies the process of installing and running a local AI by providing a holistic environment for finding the best AI models and characters and chatting with them. It prioritizes privacy by ensuring all of your chats remain private and local, while offering a cloud option for those who wish to see increased speeds or quality of models. Supported by an active development team and active community of character creators, Faraday ensures that you remain on the cutting edge of this technology without needing to spend time learning how to make it work. Whether you want to chat, roleplay or use it for productivity, Faraday will make running a local AI an easy and engaging experience.
