...
The Faraday Model Manager makes it easy to find the latest and best open source models, any of which can be used to power your conversations. It is updated frequently as new models are released.
...
**Faraday works with GGUF files**, and GGML files may work but are deprecated. All the files on Faraday's supported models list are GGUF.
