...
Tethering allows you to utilize all the features of the Faraday desktop app from your mobile device. It uses your local computer's resources as a server for your mobile browser.
