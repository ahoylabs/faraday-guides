...
Tethering allows you to utilize all the features of the Faraday Desktop App, but from your mobile device. This is done by using the Faraday Desktop App as a server for your mobile browser.
