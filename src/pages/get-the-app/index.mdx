...
**Faraday is a chat application that enables rich, meaningful interactions with personalized AI.** It is designed to run locally on your device with zero configuration.

- ⚒️ **Plug and Play**: Simply download the app, select a model and character, and start chatting. Zero coding knowledge required.
- 💪 **Data Ownership**: Chat data is stored locally on your device, ensuring full privacy and control. You alone have ownership over your AI.
- 🤖 **Community Characters**: Browse a catalog of diverse AI personalities designed by Faraday's vibrant creator community.

Faraday is currently a Desktop application, with mobile support coming soon. There is also a cloud option for enahnced speed and quality.

Backed by a dedicated development team and a vibrant character creator community, Faraday keeps you at the forefront of AI without the learning curve.

Faraday simplifies the process of installing and running a local AI by providing a streamlined environment for finding the best AI models and characters and chatting with them. It prioritizes privacy by ensuring all of your chats remain private and local, while offering a cloud option for those who wish to see increased speeds or quality of models. Supported by an active development team and active community of character creators, Faraday ensures that you remain on the cutting edge of this technology without needing to spend time learning how to make it work. Whether you want to chat, roleplay or use it for productivity, Faraday will make running a local AI an easy and engaging experience.

![Faraday Chat Screen](/images/Faraday_Chat_Screen.png)
